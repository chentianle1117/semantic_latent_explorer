...
export const TUTORIAL_STEPS: TutorialStep[] = [
...

  {
    ...
    description: '',
    instruction: 'Click the **Tune** button between the axis labels to open **Axis Tuning Mode**. A blue border and crosshair cursor appear on the canvas — shoes can now be **dragged onto the tuning rail** as anchors.',
...

  {
    ...
    title: 'Image Anchors',
    description: '',
    instruction: '**Drag any shoe** from the canvas toward the rail — a ghost thumbnail follows your cursor and a **shadow preview** snaps into position on the rail. Release over the rail to place the anchor. **Drag existing anchors** along the 0-10 scale to reposition them. Anchors near 10 push the axis toward that shoe; anchors near 0 push it away.',
    targetSelector: '[data-tour="axis-tuning-rail"]',
    cardPosition: 'right',
    isInformational: true,
  },
