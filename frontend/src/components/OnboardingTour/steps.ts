...
export const TUTORIAL_STEPS: TutorialStep[] = [
...

  {
    ...
    title: 'Select a Shoe',
    description: '',
    instruction: '**Click any shoe** to select it — it gets a bright glow. **Click more shoes** to add them to the selection. You can also **left-drag** across the canvas to box-select multiple shoes. **Right-drag** pans the canvas, **scroll** zooms.',
...

  {
    ...
    title: 'Lineage View',
    description: '',
    instruction: 'Click **Lineage** (top-right toggle) to switch to a full-canvas family tree. Node colors: **orange** = reference shoes, **green** = AI-generated, **purple** = AI agent. Lines show parent→child relationships. **Right-drag** to pan, **scroll** to zoom. When done, **click Semantic to switch back** — the rest of the tutorial uses the semantic view.',
...

  {
    ...
    title: 'Open Axis Tuning',
    description: '',
    instruction: '**Click the Tune button** between the axis labels to open Axis Tuning Mode. A blue border and crosshair cursor will appear on the canvas.',
    targetSelector: '[data-tour="axis-tune-btn"]',
    cardPosition: 'above',
    completionKey: 'c-axis-tune-intro',
  },

  {
    ...
    description: '',
    instruction: 'The tuning panel shows **AI-expanded sentences** for each axis end (e.g. "formal" → "plain canvas, rubber sole"). You can **edit these directly** or use the **AI Refine** box to describe changes in natural language.',
...

  {
    ...
    title: 'Image Anchors',
    description: '',
    instruction: '**Drag any shoe** from the canvas toward the rail — a ghost thumbnail follows your cursor and a **shadow preview** snaps into position. Release over the rail to place. **Drag existing anchors** to reposition. Anchors near 10 push the axis toward that shoe; near 0 pushes away.',
    targetSelector: '[data-tour="axis-tuning-rail"]',
    cardPosition: 'right',
    isInformational: true,
  },

  {
    ...
    section: 'c',
    atomicUnit: 'axis-tuning',
    title: 'Reproject & Exit',
    description: '',
    instruction: 'Adjust the **Text weight** slider to balance sentences vs. image anchors. Click **Reproject** to recalculate all positions. When done, **click ✕** to exit tuning mode.',
    targetSelector: '[data-tour="axis-tuning-rail"]',
    cardPosition: 'right',
    completionKey: 'c-axis-tune-reproject',
  },
